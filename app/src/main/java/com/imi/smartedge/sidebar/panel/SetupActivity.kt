...
class SetupActivity : AppCompatActivity() {
    ...
    private fun updateUI() {
        ...
        binding.titleAutomation.text = getString(R.string.native_gesture_status, status)
        ...
        if (allGranted) {
            binding.btnGrantAll.text = getString(R.string.ui_all_granted)
            binding.btnGrantAll.alpha = 0.5f
        } else {
            binding.btnGrantAll.text = getString(R.string.ui_grant_all)
