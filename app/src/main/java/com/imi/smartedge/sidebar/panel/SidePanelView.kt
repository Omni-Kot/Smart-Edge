...
class SidePanelView @JvmOverloads constructor(
    ...
    private val interactionHandler = android.os.Handler(android.os.Looper.getMainLooper())
    ...
    private fun updateSystemInfo() {
        ...
        try {
            ...
            binding.tvRamUsage.text = context.getString(R.string.ram_usage, usedMegs)

            val intent = context.registerReceiver(null, android.content.IntentFilter(android.content.Intent.ACTION_BATTERY_CHANGED))
            val temp = intent?.getIntExtra(android.os.BatteryManager.EXTRA_TEMPERATURE, 0) ?: 0
            binding.tvBatTemp.text = context.getString(R.string.battery_temperature, temp / 10)
        } catch (e: Exception) {}
    }
    ...
    init {
        ...
        val performVolumeChange = { direction: Int, view: View ->
            ...
            showIndicator(context.getString(R.string.volume_percent, percent))
        }
        ...
        val performBrightnessChange = { delta: Int, view: View ->
            ...
            try {
                if (!android.provider.Settings.System.canWrite(context)) {
                    android.widget.Toast.makeText(context, context.getString(R.string.ui_requires_write_system_settings_permission), android.widget.Toast.LENGTH_SHORT).show()
                    ...
                    showIndicator(context.getString(R.string.brightness_percent, percent))
                }
            } catch (e: Exception) {
        ...
        binding.btnReboot.setOnClickListener {
            ...
            ActionDispatcher.performAction(context, PanelPreferences.ACTION_POWER_MENU, panelPrefs)
            onClose?.invoke()
        }
