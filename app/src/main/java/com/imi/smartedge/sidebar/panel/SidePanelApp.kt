...
class SidePanelApp : Application() {
    ...
    override fun onTrimMemory(level: Int) {
        ...
        if (level >= TRIM_MEMORY_RUNNING_LOW) AppRepository.clearSystemIconCache()
    }
    ...
    override fun onCreate() {
        ...
        if (PanelPreferences(this).useAutomationForGestures) AutomationManager.refreshRoot()
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.P) {
            ...
            try {
                ...
                addExemptionsMethod.invoke(null, arrayOf("Landroid/app/ActivityOptions;") as Any)
                bypassSuccess = true
            ...
            if (!bypassSuccess) {
                try {
                    ...
                    setHiddenApiExemptions.invoke(vmRuntime, arrayOf(arrayOf("Landroid/app/ActivityOptions;")))
