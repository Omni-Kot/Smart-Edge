...
class SettingsMainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnForkOriginal.setOnClickListener { openGithub() }
    ...
    private fun initializeSettingsList() {
        ...
        allSettings.add(SettingItem(getString(R.string.view_repo_title), getString(R.string.view_repo_desc), getString(R.string.ui_project), "github source code open repo smartedge", SettingsMainActivity::class.java, "btnGithubTop"))
    ...
    private fun getCategoryFromLayout(layoutId: Int): String = when (layoutId) {
        ...
        R.layout.activity_settings_handle -> getString(R.string.ui_handle)
        R.layout.activity_settings_tools -> getString(R.string.ui_tools)
    ...
    private inner class SearchResultsAdapter(private val onClick: (SettingItem) -> Unit) : 
        ...
        inner class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
            ...
            fun bind(item: SettingItem) {
                ...
                desc.text = desc.context.getString(R.string.search_result_description, item.category, item.description)
