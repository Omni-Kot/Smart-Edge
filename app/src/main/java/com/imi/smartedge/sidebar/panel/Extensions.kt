...
fun Context.openFreeformDeveloperSettings() {
    ...
    try {
        ...
        try {
            ...
            android.widget.Toast.makeText(this, getString(R.string.ui_developer_options_not_found), android.widget.Toast.LENGTH_SHORT).show()
        }
    }
}
 ...
 */
fun Context.isAccessibilityServiceEnabled(): Boolean = PanelCapabilities.accessibilityEnabled(this)
...
fun Context.openColorPicker(initialColor: Int, onPick: (Int) -> Unit) {
    ...
    val hexInputLayout = com.google.android.material.textfield.TextInputLayout(this, null, com.google.android.material.R.attr.textInputOutlinedStyle).apply {
        hint = getString(R.string.ui_hex_color_aarrggbb)
    ...
    com.google.android.material.dialog.MaterialAlertDialogBuilder(this)
        .setTitle(getString(R.string.ui_choose_color))
        .setView(rootLayout)
        .setPositiveButton(getString(R.string.ui_select)) { _, _ ->
            onPick(currentColor)
        }
