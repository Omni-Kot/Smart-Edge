...
class IconPackPickerDialog : BottomSheetDialogFragment() {
    ...
    override fun onCreateView(
        ...
        val tvTitle = TextView(ctx).apply {
            text = requireContext().getString(R.string.ui_select_icon_pack)
            textSize = 20f
            setTextColor(Color.WHITE)
            typeface = Typeface.DEFAULT_BOLD
        }
        val tvStatus = TextView(ctx).apply {
            val label = if (panelPrefs.selectedIconPack == "none") requireContext().getString(R.string.icon_pack_default) else panelPrefs.iconPackLabel
            text = requireContext().getString(R.string.current_icon_pack, label)
            textSize = 12f
        ...
        val searchContainer = com.google.android.material.textfield.TextInputLayout(ctx).apply {
            ...
            hint = requireContext().getString(R.string.ui_search_icon_packs)
        ...
        allPacks.add(IconPackInfo("none", requireContext().getString(R.string.icon_pack_default), ctx.getDrawable(android.R.drawable.sym_def_app_icon)!!))
    ...
    inner class PackAdapter(
        ...
        override fun onBindViewHolder(holder: VH, position: Int) {
            ...
            holder.pkg.text = if (item.packageName == "none") requireContext().getString(R.string.ui_default_app_icons) else item.packageName
