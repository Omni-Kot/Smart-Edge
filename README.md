...
This fork separates the interface text from the application logic and provides a resource-based localization structure. It includes a Russian translation and corrected Spanish resources. The upstream project is [Imtiaz-Official/Smart-Edge](https://github.com/Imtiaz-Official/Smart-Edge).
